...
![studio_1](/assets/AutoML/s1.png){:.aligncenter}
...
![studio_2](/assets/AutoML/s2.png){:.aligncenter}
...
![studio_3](/assets/AutoML/s3.png){:.aligncenter}

6) 테이블 1필드 Description파일 형식파일에 저장된 데이터의 **레이아웃 및 유형을 정의**

![studio_4](/assets/AutoML/s4.png){:.aligncenter}
...
![studio_5](/assets/AutoML/s5.png){:.aligncenter}
...
![studio_6](/assets/AutoML/s6.png){:.aligncenter}
...
![studio_7](/assets/AutoML/s7.png){:.aligncenter}
...
![studio_8](/assets/AutoML/s8.png){:.aligncenter}
...
![studio_9](/assets/AutoML/s9.png){:.aligncenter}
...
![studio_10](/assets/AutoML/s10.png){:.aligncenter}

- 모델을 선택한 후 세부정보, 메트릭 등을 통해 확인이 가능

![studio_11](/assets/AutoML/s11.png){:.aligncenter}
